...
XMLNode::XMLNode( tinyxml2::XMLDocument* doc ) :
	document( doc ),
	parent( 0 ),
...
XMLNode* XMLText::ShallowClone( tinyxml2::XMLDocument* doc ) const
{
	if ( !doc ) {
		doc = document;
	}
...
XMLComment::XMLComment( tinyxml2::XMLDocument* doc ) : XMLNode( doc )
{
}
...
XMLNode* XMLComment::ShallowClone( tinyxml2::XMLDocument* doc ) const
{
	if ( !doc ) {
		doc = document;
	}
...
XMLDeclaration::XMLDeclaration( tinyxml2::XMLDocument* doc ) : XMLNode( doc )
{
}
...
XMLNode* XMLDeclaration::ShallowClone( tinyxml2::XMLDocument* doc ) const
{
	if ( !doc ) {
		doc = document;
	}
...
XMLUnknown::XMLUnknown( tinyxml2::XMLDocument* doc ) : XMLNode( doc )
{
}
...
XMLNode* XMLUnknown::ShallowClone( tinyxml2::XMLDocument* doc ) const
{
	if ( !doc ) {
		doc = document;
	}
...
// --------- XMLElement ---------- //
XMLElement::XMLElement( tinyxml2::XMLDocument* doc ) : XMLNode( doc ),
	closingType( 0 ),
	rootAttribute( 0 )
{
}
...
XMLNode* XMLElement::ShallowClone( tinyxml2::XMLDocument* doc ) const
{
	if ( !doc ) {
		doc = document;
	}
...
// --------- XMLDocument ----------- //
tinyxml2::XMLDocument::XMLDocument( bool _processEntities ) :
	XMLNode( 0 ),
	writeBOM( false ),
...
void tinyxml2::XMLDocument::InitDocument()
{
...
XMLComment* tinyxml2::XMLDocument::NewComment( const char* str )
{
...
XMLText* tinyxml2::XMLDocument::NewText( const char* str )
{
	XMLText* text = new (textPool.Alloc()) XMLText( this );
...
XMLDeclaration* tinyxml2::XMLDocument::NewDeclaration( const char* str )
{
...
XMLUnknown* tinyxml2::XMLDocument::NewUnknown( const char* str )
{
...
int tinyxml2::XMLDocument::LoadFile( const char* filename )
{
	DeleteChildren();
	InitDocument();
...
int tinyxml2::XMLDocument::LoadFile( FILE* fp ) 
{
	DeleteChildren();
	InitDocument();
...
int tinyxml2::XMLDocument::SaveFile( const char* filename )
{
#if defined(_MSC_VER)
#pragma warning ( push )
#pragma warning ( disable : 4996 )		// Fail to see a compelling reason why this should be deprecated.
...
int tinyxml2::XMLDocument::SaveFile( FILE* fp )
{
...
int tinyxml2::XMLDocument::Parse( const char* p )
{
	DeleteChildren();
	InitDocument();
...
void tinyxml2::XMLDocument::Print( XMLPrinter* streamer ) 
{
...
void tinyxml2::XMLDocument::SetError( int error, const char* str1, const char* str2 )
{
	errorID = error;
	errorStr1 = str1;
	errorStr2 = str2;
...
bool XMLPrinter::VisitEnter( const tinyxml2::XMLDocument& doc )
{
